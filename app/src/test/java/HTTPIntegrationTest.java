...
import static back.user.Notification.fetchCustomNotification;
...
public class HTTPIntegrationTest {
    ...
    public void getNotifications() {
        assertDoesNotThrow(() -> {
            ArrayList<Notification> notifList = fetchCustomNotification();
    ...
    public void changeFlag() {
        ...
        Notification notifTest = fetchCustomNotification().get(0);
        ...
        Notification notifTest2 = fetchCustomNotification().get(0);
